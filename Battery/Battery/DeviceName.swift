...
public extension UIDevice {
    static let modelName: String = {
        ...
        // i copied this part of code from the internet so i don't really know what this does, but returns the model name and then transforms it into like iPhone 7 Plus
        ...
        func mapToDevice(identifier: String) -> String {
            ...
            case "iPad8,10", "iPad8,11", "iPad8,12":                return "iPad Pro (11-inch) (4th gen)"
